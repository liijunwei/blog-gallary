...
- 2026-04-14 23:34:35 [Apache Beam®](https://beam.apache.org/)
...
- 2025-10-12 00:11:12 回来吧

- 2025-10-01 22:59:46 拙劣的马奎啊，你就是峨眉峰
...
- 2025-08-01 20:46:35 马克进入灵犀子最后和冉冰告别的那段真是催泪

- 2025-07-31 09:06:36 [simplecache/simplecache.go at main · boyter/simplecache](https://github.com/boyter/simplecache/blob/main/simplecache.go)
...
- 2025-03-18 23:05:39 review: [Executing transactions - The Go Programming Language](https://go.dev/doc/database/execute-transactions)
...
- 2025-03-05 08:58:51 `miniserve --upload-files . --qrcode -U .`
...
- 2024-11-17 23:22:54 [Quick tip: Implementing an in-memory cache in Go – Alex Edwards](https://www.alexedwards.net/blog/implementing-an-in-memory-cache-in-go)
...
- 2024-10-31 09:38:55 [Integer partition - Wikipedia](https://en.wikipedia.org/wiki/Integer_partition)
...
- 2024-10-05 09:20:52 [Jobs – HTTPie](https://httpie.io/jobs)
...
- 2024-09-21 08:36:22 [blogs of Ted Kaminski](https://www.tedinski.com/archive/)
...
- 2024-09-16 11:52:51 [Justine Tunney's Web Page](https://justine.lol/)
...
- 2024-05-10 18:08:17 [charmbracelet/gum: A tool for glamorous shell scripts 🎀](https://github.com/charmbracelet/gum)
...
- 2024-04-12 10:48:23 [git.openwrt.org Git - projects in 'project'](https://git.openwrt.org/?a=project_list;pf=project)
...
- 2024-04-06 11:47:40 vscode user setting `"window.newWindowDimensions": "maximized",`
...
- 2023-08-31 10:06:25 [Ruby Outperforms C: Breaking the Catch-22 | Rails at Scale](https://railsatscale.com/2023-08-29-ruby-outperforms-c/)
...
- 2023-07-17 16:34:18 [4.0.0 — Homebrew](https://brew.sh/2023/02/16/homebrew-4.0.0/)
...
- 2023-05-16 22:26:57 ["Every function in Haskell officially only takes one parameter."](http://learnyouahaskell.com/higher-order-functions)
...
- 2023-04-14 23:44:15 `Enumerable#sort_by`: ["Sorts enum using a set of keys generated by mapping the values in enum through the given block."](https://ruby-doc.org/3.2.2/Enumerable.html#method-i-sort_by) 如果向这个方法的块里传入一个数组，它的语意和SQL里根据多个字段做`order by` 是一致的，能极大简化特定类型场景的代码，妙啊；和同事们讨论真是受益匪浅
...
- 2023-04-01 23:01:41 [GNU Emacs Manual](https://www.gnu.org/software/emacs/manual/html_node/emacs/index.html#SEC_Contents)
...
- 2023-03-20 10:29:29 今天早晨理解了哈希表作为索引的用法，联想到rails activesupport里的`index_by`, 它的含义更加具体了；但是有一点需要注意: `index_by` 没法处理数组里的重复元素，如果有重复元素，想要得到预期的结果，应该用`Enumerable#group_by`
...
- 2023-03-12 22:07:02 评论区和文章一样精彩: [量产型炮灰工程师 · Ruby China](https://ruby-china.org/topics/33036)

- 2023-03-12 22:04:43 review一下加深印象: [Ruby-Functional-Programming/README-zhCN.md at master](https://github.com/JuanitoFatas/Ruby-Functional-Programming/blob/master/README-zhCN.md)
...
- 2023-03-01 13:54:16 [2023 年成為外商裁員的天選之人該做些什麼？ | 弦而時習之](https://blog.aotoki.me/posts/2023/01/16/if-you-be-layoff-in-2023-what-can-you-do/)

- 2023-03-01 13:51:19 还没向大佬学习过，他却已经离开公司了... 好可惜. [寫程式最困難的地方｜方格子 vocus](https://vocus.cc/article/61cbf625fd8978000153f922)
...
- 2023-02-17 15:52:57 [Why does 0.1 + 0.2 = 0.30000000000000004?](https://jvns.ca/blog/2023/02/08/why-does-0-1-plus-0-2-equal-0-30000000000000004/), 感觉这是基础知识，但就是提不起兴趣...
...
- 2023-02-13 23:06:51 ["same old classic mistakes"](https://blog.codinghorror.com/escaping-from-gilligans-island/)
...
- 2023-02-03 14:57:00 tmux `Ctrl + b ?`
...
- 2023-01-28 17:43:01 [A Simple Data Equation | Kris Jenkins' Blog](http://blog.jenkster.com/2013/02/a-simple-data-equation.html)
...
- 2023-01-09 22:28:27 [[经验之谈] 转行做程序员的 8 个月 · Ruby China](https://ruby-china.org/topics/19961), 不记得上次读这篇blog是什么时候了, 不过里面有我的点赞, 大概是刚刚入行的时候吧

- 2023-01-09 22:17:12 突然想起来之前笑来老师提到的 "重视一切老生常谈", 有些感慨, 自己很普通, 却也没有免掉掉进自作聪明的陷阱

- 2023-01-09 22:12:36 ["恩 看表象然后自己设计实现一套，然后再参考已有的... 我是这样学习的"](https://ruby-china.org/topics/27912#reply-279431)

- 2023-01-09 19:45:55 [豆瓣电影 Top 250](https://movie.douban.com/top250) 据说这个列表质量很高, 用来下饭吧
...
- 2022-12-30 10:03:13 刚刚注意到关注挺久的一个B站玩泥巴UP主 [搞事明天玩什么](https://space.bilibili.com/299580163) 粉丝竟然已经涨到了80万, 恭喜恭喜～
...
- 2022-12-26 09:56:15 [Sidekiq FAQ: How do I push a job to Sidekiq without Ruby?](https://github.com/mperham/sidekiq/wiki/FAQ#how-do-i-push-a-job-to-sidekiq-without-ruby), the jid was generated by client
...
- 2022-10-31 09:08:12 ["port 10101" read as "port lolol" 哈哈哈哈](https://youtu.be/sLb7Uz9KOqc?t=1512)

- 2022-10-31 09:05:28 that's actually worse in a better way... lol

- 2022-10-31 09:04:41 Aaron Patterson (@tenderlove) 在["Worst. Ideas. Ever"](https://www.youtube.com/watch?v=sLb7Uz9KOqc)视频里看起来好腼腆(错觉吗...) 感觉很亲切, 但看过他的博客就会知道,他很硬核...
...
- 2022-10-22 18:19:54 Q: What is the difference between a framework and library? A: `your code` calls `library code`, and `framework code` calls `your code`, framework contains library
...
- 2022-10-20 14:58:28 `bundle outdated`
...
- 2022-10-04 18:17:34 TODO [learn DDD](https://martinfowler.com/tags/domain%20driven%20design.html)
...
- 2022-09-29 12:52:43 fun: `man zshbuiltins`
...
- 2022-08-27 09:28:36 [数据结构和算法基本浏览完了](https://time.geekbang.org/column/article/78795), 今早听到最后有个思考题: "假设我们有 n 个任务，为了提高执行的效率，我们希望能并行执行任务，但是各个任务之间又有一定的依赖关系，如何根据依赖关系找出可以并行执行的任务？" --- 其实我没有思路, 所以看了一眼评论区的答案, 使用"拓扑排序的思想", 借助有向图这种数据结构存储依赖关系, 然后排序就好了; 看完既有惶恐也有兴奋, 惶恐在当脑袋里没有概念的时候, 就不可能有解决办法; 兴奋在它并不会很难掌握,掌握后就很难在忘掉了, 使用他们解决问题想想就很有趣
...
- 2022-08-05 23:32:54 ["制定目标和绩效，目的不是用来考核人的，而用来改善提高组织和人员业绩和效率的。"](https://coolshell.cn/articles/17972.html)
...
- 2022-05-13 14:42:56 [List of ISO 3166 country codes](https://en.wikipedia.org/wiki/List_of_ISO_3166_country_codes)
...
- 2022-05-13 08:32:35 [这个代码写的真好](https://github.com/pepito2k/gitalytics/tree/master/lib/gitalytics)
...
- 2022-04-18 23:31:17 ["make your program output grepable/cutable, use standard exit codes, stderr and stdout for your command line application"](https://youtu.be/1ILEw6Qca3U?t=444)
...
- 2022-03-23 23:43:02 [UTF-8 and Unicode](https://www.utf8.com/)
...
- 2022-03-17 23:36:32 util: [ruby api](https://rubyapi.org/)
...
- 2022-03-05 17:47:37 good blogs: [你必读的 RSS 订阅源有哪些？](https://www.zhihu.com/question/19580096/answer/2375036996)
...
- 2022-02-27 23:57:01 [Simplify, simplify, simplify. --- kill your dependencies](https://www.mikeperham.com/2016/02/09/kill-your-dependencies/)
...
- 2022-02-15 11:05:54 TODO 记录想法的`thought`并不能促进思考, 要进行扩展, 把一个想法扩展成小篇的文章
